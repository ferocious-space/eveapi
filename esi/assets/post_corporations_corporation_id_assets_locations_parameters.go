...
func (o *PostCorporationsCorporationIDAssetsLocationsParams) WithDefaults() *PostCorporationsCorporationIDAssetsLocationsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *PostCorporationsCorporationIDAssetsLocationsParams) SetDefaults() {
	var (
		datasourceDefault = string("tranquility")
	)

	val := PostCorporationsCorporationIDAssetsLocationsParams{
