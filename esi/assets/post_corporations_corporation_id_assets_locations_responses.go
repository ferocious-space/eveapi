...
func (o *PostCorporationsCorporationIDAssetsLocationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 504:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /v2/corporations/{corporation_id}/assets/locations/] post_corporations_corporation_id_assets_locations", response, response.Code())
	}
}
