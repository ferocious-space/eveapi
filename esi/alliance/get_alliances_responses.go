...
func (o *GetAlliancesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 504:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/alliances/] get_alliances", response, response.Code())
	}
}
...
func (o *GetAlliancesInternalServerError) Code() int {
	return 500
}
...
func (o *GetAlliancesInternalServerError) String() string {
	return fmt.Sprintf("[GET /v1/alliances/][%d] getAlliancesInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetAlliancesServiceUnavailable) Code() int {
	return 503
}
...
func (o *GetAlliancesServiceUnavailable) String() string {
	return fmt.Sprintf("[GET /v1/alliances/][%d] getAlliancesServiceUnavailable  %+v", 503, o.Payload)
}
