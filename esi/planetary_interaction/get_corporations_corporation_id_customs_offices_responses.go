...
func (o *GetCorporationsCorporationIDCustomsOfficesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 504:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/corporations/{corporation_id}/customs_offices/] get_corporations_corporation_id_customs_offices", response, response.Code())
	}
}
