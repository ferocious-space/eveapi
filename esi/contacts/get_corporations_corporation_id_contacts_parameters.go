...
func (o *GetCorporationsCorporationIDContactsParams) WithDefaults() *GetCorporationsCorporationIDContactsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetCorporationsCorporationIDContactsParams) SetDefaults() {
	var (
	...
	val := GetCorporationsCorporationIDContactsParams{
