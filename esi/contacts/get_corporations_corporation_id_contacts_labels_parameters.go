...
func (o *GetCorporationsCorporationIDContactsLabelsParams) WithDefaults() *GetCorporationsCorporationIDContactsLabelsParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetCorporationsCorporationIDContactsLabelsParams) SetDefaults() {
	var (
		datasourceDefault = string("tranquility")
	)

	val := GetCorporationsCorporationIDContactsLabelsParams{
