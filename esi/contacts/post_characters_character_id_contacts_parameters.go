...
func (o *PostCharactersCharacterIDContactsParams) WithDefaults() *PostCharactersCharacterIDContactsParams {
	o.SetDefaults()
	return o
}
...
func (o *PostCharactersCharacterIDContactsParams) SetDefaults() {
	...
	val := PostCharactersCharacterIDContactsParams{
...
// bindParamPostCharactersCharacterIDContacts binds the parameter label_ids
func (o *PostCharactersCharacterIDContactsParams) bindParamLabelIds(formats strfmt.Registry) []string {
