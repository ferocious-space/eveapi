...
func (o *GetCharactersCharacterIDContractsContractIDBidsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 504:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/characters/{character_id}/contracts/{contract_id}/bids/] get_characters_character_id_contracts_contract_id_bids", response, response.Code())
	}
}
