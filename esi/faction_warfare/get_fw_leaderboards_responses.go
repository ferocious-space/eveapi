...
func (o *GetFwLeaderboardsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 504:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/fw/leaderboards/] get_fw_leaderboards", response, response.Code())
	}
}
...
// Code gets the status code for the get fw leaderboards o k response
func (o *GetFwLeaderboardsOK) Code() int {
	return 200
}
...
// Code gets the status code for the get fw leaderboards not modified response
func (o *GetFwLeaderboardsNotModified) Code() int {
	return 304
}
...
// Code gets the status code for the get fw leaderboards bad request response
func (o *GetFwLeaderboardsBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the get fw leaderboards enhance your calm response
func (o *GetFwLeaderboardsEnhanceYourCalm) Code() int {
	return 420
}
...
// Code gets the status code for the get fw leaderboards internal server error response
func (o *GetFwLeaderboardsInternalServerError) Code() int {
	return 500
}
...
// Code gets the status code for the get fw leaderboards service unavailable response
func (o *GetFwLeaderboardsServiceUnavailable) Code() int {
	return 503
}
...
// Code gets the status code for the get fw leaderboards gateway timeout response
func (o *GetFwLeaderboardsGatewayTimeout) Code() int {
	return 504
}
	...
	if o.Kills != nil {
		if err := o.Kills.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("getFwLeaderboardsOK" + "." + "kills")
			}
			return err
		}
	}
	...
	if o.VictoryPoints != nil {
		if err := o.VictoryPoints.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("getFwLeaderboardsOK" + "." + "victory_points")
			}
			return err
		}
	}
		...
		if o.ActiveTotal[i] != nil {
			if err := o.ActiveTotal[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("getFwLeaderboardsOK" + "." + "kills" + "." + "active_total" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.LastWeek[i] != nil {
			if err := o.LastWeek[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("getFwLeaderboardsOK" + "." + "kills" + "." + "last_week" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.Yesterday[i] != nil {
			if err := o.Yesterday[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("getFwLeaderboardsOK" + "." + "kills" + "." + "yesterday" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.ActiveTotal[i] != nil {
			if err := o.ActiveTotal[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("getFwLeaderboardsOK" + "." + "victory_points" + "." + "active_total" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.LastWeek[i] != nil {
			if err := o.LastWeek[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("getFwLeaderboardsOK" + "." + "victory_points" + "." + "last_week" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if o.Yesterday[i] != nil {
			if err := o.Yesterday[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("getFwLeaderboardsOK" + "." + "victory_points" + "." + "yesterday" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
