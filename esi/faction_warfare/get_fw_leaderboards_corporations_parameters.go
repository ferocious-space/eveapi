...
// WithDefaults hydrates default values in the get fw leaderboards corporations params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFwLeaderboardsCorporationsParams) WithDefaults() *GetFwLeaderboardsCorporationsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get fw leaderboards corporations params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetFwLeaderboardsCorporationsParams) SetDefaults() {
	var (
		datasourceDefault = string("tranquility")
	)

	val := GetFwLeaderboardsCorporationsParams{
