...
// WithDefaults hydrates default values in the get corporations corporation id fw stats params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCorporationsCorporationIDFwStatsParams) WithDefaults() *GetCorporationsCorporationIDFwStatsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get corporations corporation id fw stats params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetCorporationsCorporationIDFwStatsParams) SetDefaults() {
	var (
		datasourceDefault = string("tranquility")
	)

	val := GetCorporationsCorporationIDFwStatsParams{
