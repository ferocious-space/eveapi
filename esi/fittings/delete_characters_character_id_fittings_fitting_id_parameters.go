...
func (o *DeleteCharactersCharacterIDFittingsFittingIDParams) WithDefaults() *DeleteCharactersCharacterIDFittingsFittingIDParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *DeleteCharactersCharacterIDFittingsFittingIDParams) SetDefaults() {
	var (
		datasourceDefault = string("tranquility")
	)

	val := DeleteCharactersCharacterIDFittingsFittingIDParams{
