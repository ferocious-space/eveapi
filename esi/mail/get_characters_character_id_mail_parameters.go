...
func (o *GetCharactersCharacterIDMailParams) SetDefaults() {
	...
	val := GetCharactersCharacterIDMailParams{
...
// bindParamGetCharactersCharacterIDMail binds the parameter labels
func (o *GetCharactersCharacterIDMailParams) bindParamLabels(formats strfmt.Registry) []string {
	labelsIR := o.Labels

	var labelsIC []string
	for _, labelsIIR := range labelsIR { // explode []int32

		labelsIIV := swag.FormatInt32(labelsIIR) // int32 as string
