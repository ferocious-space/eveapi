...
func (o *GetUniverseTypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 504:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/universe/types/] get_universe_types", response, response.Code())
	}
}
...
func (o *GetUniverseTypesEnhanceYourCalm) Code() int {
	return 420
}
...
func (o *GetUniverseTypesInternalServerError) Code() int {
	return 500
}
...
func (o *GetUniverseTypesServiceUnavailable) Code() int {
	return 503
}
...
func (o *GetUniverseTypesGatewayTimeout) Code() int {
	return 504
}
