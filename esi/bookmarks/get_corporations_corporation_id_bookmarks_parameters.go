...
func (o *GetCorporationsCorporationIDBookmarksParams) WithDefaults() *GetCorporationsCorporationIDBookmarksParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetCorporationsCorporationIDBookmarksParams) SetDefaults() {
	var (
	...
	val := GetCorporationsCorporationIDBookmarksParams{
