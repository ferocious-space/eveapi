...
func (o *GetCorporationsCorporationIDBookmarksFoldersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 504:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/corporations/{corporation_id}/bookmarks/folders/] get_corporations_corporation_id_bookmarks_folders", response, response.Code())
	}
}
