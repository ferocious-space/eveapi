...
func (o *GetCorporationsCorporationIDMembersTitlesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 504:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v2/corporations/{corporation_id}/members/titles/] get_corporations_corporation_id_members_titles", response, response.Code())
	}
}
