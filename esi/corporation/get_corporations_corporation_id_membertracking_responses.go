...
func (o *GetCorporationsCorporationIDMembertrackingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 504:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v2/corporations/{corporation_id}/membertracking/] get_corporations_corporation_id_membertracking", response, response.Code())
	}
}
